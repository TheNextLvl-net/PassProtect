...
import passprotect.client.data.application.ApplicationData;
import passprotect.client.adapter.FileAdapter;
import passprotect.client.data.application.ApplicationState;
import passprotect.client.form.InstallationForm;
import passprotect.client.util.Version;
