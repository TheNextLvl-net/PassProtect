...
import net.thenextlvl.passprotect.api.dictionary.Dictionary;
...
public class Password implements Entry {
    ...
    public Password(String name, @Nullable String description, byte[] password) {
        this.name = name;
        this.description = description;
        this.password = password;
    }

    public Password(String name, byte[] password) {
    ...
    public static class Lookup {
        ...
        @Nonnull
        public static Pair<Integer, String> test(String password) {
