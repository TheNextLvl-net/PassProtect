...
import net.thenextlvl.core.api.object.Getter;
...
public class BackupCodeEntry extends JDialog {
    ...
    public BackupCodeEntry(BackupCode backupCode, Config config, CloseEvent closeEvent) {
    ...
    public interface CloseEvent {
        boolean close(Getter<BackupCode> backupCode, CloseEvent.Type type);
