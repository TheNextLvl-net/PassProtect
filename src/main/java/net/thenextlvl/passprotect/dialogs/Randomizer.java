...
public class Randomizer extends JDialog {
    ...
    public Randomizer(Dialog owner, CloseEvent closeEvent) {
    ...
    private void close(String password, CloseEvent.Type type) {
        closeEvent.close(password, type);
        dispose();
    }

    public interface CloseEvent {
        void close(String password, CloseEvent.Type type);
