...
import net.thenextlvl.passprotect.Installer;
...
public class Launcher extends Panel {
    ...
    public Launcher() {
        ...
        if (net.thenextlvl.passprotect.Launcher.getFile() == null) {
        ...
        ActionListener action = actionEvent -> {
            ...
            if (startRadioButton.isSelected()) {
                net.thenextlvl.passprotect.Launcher.start(installedCheckBox.isSelected());
