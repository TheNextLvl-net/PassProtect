...
import net.thenextlvl.core.api.object.TriFunction;
...
import net.thenextlvl.passprotect.api.nodes.*;
import net.thenextlvl.passprotect.api.renderer.TreeIconRenderer;
import net.thenextlvl.passprotect.dialogs.ActiveDialogs;
import net.thenextlvl.passprotect.dialogs.PasswordReminder;
import net.thenextlvl.passprotect.dialogs.Preferences;
import net.thenextlvl.passprotect.dialogs.entries.BackupCodeEntry;
import net.thenextlvl.passprotect.dialogs.entries.FileEntry;
import net.thenextlvl.passprotect.dialogs.entries.PasswordEntry;
import net.thenextlvl.passprotect.dialogs.entries.TOTPEntry;
...
public class Menu extends Panel {
    ...
    private void registerListeners() {
        ...
        categories.addTreeExpansionListener(new TreeExpansionListener() {
            ...
            private void expandPasswordTreeNode(TreeExpansionEvent event) {
            ...
            private void expandBackupCodeTreeNode(TreeExpansionEvent event) {
            ...
            private void expandFileTreeNode(TreeExpansionEvent event) {
            ...
            private void expandTOTPTreeNode(TreeExpansionEvent event) {
            ...
            private void collapseTreeNode(EntryTreeNode<?> node, TreePath path) {
                ActiveDialogs.getInstance().remove(node.identity());
                categories.collapsePath(path);
            }

            public void treeCollapsed(TreeExpansionEvent event, boolean outdated) {
    ...
    @SuppressWarnings({"rawtypes", "unchecked"})
    private void newCategory(Function<String, Category> function) {
    ...
    private void newPassword(TriFunction<String, String, byte[], Password> function) {
        CategoryTreeNode node = getSelectedCategory();
    ...
    private void newBackupCode(BiFunction<String, String[], BackupCode> function) {
        CategoryTreeNode node = getSelectedCategory();
    ...
    private void newTOTPCode(TriFunction<String, String, String, TOTP> function) {
        CategoryTreeNode node = getSelectedCategory();
    ...
    private void newFile(BiFunction<String, String[], File> function) {
        CategoryTreeNode node = getSelectedCategory();
