...
public class TrustedDevices extends JsonFile {
    ...
    @Nonnull
    public String getPassword(@Nonnull net.nonswag.tnl.adb.Device device) throws IllegalStateException, NoSuchPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, BadPaddingException, InvalidKeyException {
        JsonObject root = getJsonElement().getAsJsonObject();
    ...
    public void trust(@Nonnull net.nonswag.tnl.adb.Device device, @Nonnull String password) throws NoSuchPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, BadPaddingException, InvalidKeyException {
        JsonObject root = getJsonElement().getAsJsonObject();
    ...
    public boolean isTrusted(@Nonnull net.nonswag.tnl.adb.Device device) {
    ...
    public static class Device {
        ...
        public Device(@Nonnull net.nonswag.tnl.adb.Device device) {
