...
import net.nonswag.tnl.passprotect.api.code.QRCode;
import net.nonswag.tnl.passprotect.api.nodes.TOTPTreeNode;
...
public class TOTP implements Entry {
    ...
    public TOTP(@Nonnull String issuer, @Nonnull String accountName, @Nonnull String secretKey) {
        this.issuer = issuer;
    ...
    public static void showQRCode(@Nonnull String issuer, @Nonnull String accountName, @Nonnull String secret) throws Exception {
    ...
    @Nonnull
    private static String generateQRCode(@Nonnull String issuer, @Nonnull String accountName, @Nonnull String key) {
    ...
    @Nonnull
    private static String formatLabel(@Nonnull String issuer, @Nonnull String accountName) {
