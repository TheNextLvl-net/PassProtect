...
import net.nonswag.tnl.passprotect.api.authentication.Authenticator;
import net.nonswag.tnl.passprotect.api.code.InvalidQRCodeException;
import net.nonswag.tnl.passprotect.api.code.QRCode;
import net.nonswag.tnl.passprotect.api.entry.TOTP;
...
public class TOTPEntry extends JDialog {
    ...
    private void createUIComponents() {
        this.issuer = new TextField().setPlaceholder("Issuer");
