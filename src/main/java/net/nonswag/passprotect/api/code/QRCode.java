...
public class QRCode {
    ...
    @Nonnull
    public static File generate(@Nonnull String text) throws WriterException, IOException {
    ...
    @Nonnull
    public static String read(@Nonnull File qrCode) throws IOException, NotFoundException {
