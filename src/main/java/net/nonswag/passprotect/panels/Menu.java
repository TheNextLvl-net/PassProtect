...
import net.nonswag.core.api.object.TriFunction;
import net.nonswag.passprotect.PassProtect;
import net.nonswag.passprotect.api.entry.*;
import net.nonswag.passprotect.api.fields.TextField;
import net.nonswag.passprotect.api.files.Config;
import net.nonswag.passprotect.api.files.Storage;
import net.nonswag.passprotect.api.nodes.*;
import net.nonswag.passprotect.api.renderer.TreeIconRenderer;
import net.nonswag.passprotect.dialogs.ActiveDialogs;
import net.nonswag.passprotect.dialogs.PasswordReminder;
import net.nonswag.passprotect.dialogs.Preferences;
import net.nonswag.passprotect.dialogs.entries.BackupCodeEntry;
import net.nonswag.passprotect.dialogs.entries.FileEntry;
import net.nonswag.passprotect.dialogs.entries.PasswordEntry;
import net.nonswag.passprotect.dialogs.entries.TOTPEntry;
