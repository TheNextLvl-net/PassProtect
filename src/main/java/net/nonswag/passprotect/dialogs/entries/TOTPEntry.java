package net.nonswag.passprotect.dialogs.entries;

import net.nonswag.core.utils.StringUtil;
import net.nonswag.passprotect.PassProtect;
import net.nonswag.passprotect.api.authentication.Authenticator;
import net.nonswag.passprotect.api.code.InvalidQRCodeException;
import net.nonswag.passprotect.api.code.QRCode;
import net.nonswag.passprotect.api.entry.TOTP;
import net.nonswag.passprotect.api.fields.PasswordField;
import net.nonswag.passprotect.api.fields.TextField;
import net.nonswag.passprotect.api.files.Config;
import net.nonswag.passprotect.utils.Clipboard;
...
public class TOTPEntry extends JDialog {
    ...
    private void createUIComponents() {
        this.issuer = new net.nonswag.passprotect.api.fields.TextField().setPlaceholder("Issuer");
    ...
    public interface CloseEvent {
        boolean close(@Nonnull TOTP totp, @Nonnull CloseEvent.Type type);
