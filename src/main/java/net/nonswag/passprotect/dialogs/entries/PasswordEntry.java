...
import net.nonswag.passprotect.api.entry.Password;
...
import net.nonswag.passprotect.dialogs.Randomizer;
...
public class PasswordEntry extends JDialog {
    ...
    private void createUIComponents() {
        name = new net.nonswag.passprotect.api.fields.TextField().setPlaceholder("Login name");
